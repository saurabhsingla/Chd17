...
ActiveRecord::Schema.define(:version => 20130611095931) do

  create_table "address_table_info_asses", :force => true do |t|
    t.integer  "TableInfo_id"
  ...
  create_table "ref_countries", :force => true do |t|
    t.string   "isoCode"
